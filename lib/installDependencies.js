 ...
 */
async function installDependencies(newProjectFolder, dependencies, initPackageJson = true){
    ...
    installing.on('close', () => console.log(chalk.hex('#00FF7F').underline.bold('Project created!.')));
