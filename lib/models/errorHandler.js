...
function errorHandler(error${fileExt === 'js' ? '' : ': Error | { type: string, message: string | number }'}, req${fileExt === 'js' ? '' : ': Request'}, res${fileExt === 'js' ? '' : ': Response'}, next${fileExt === 'js' ? '' : ': NextFunction'}){
